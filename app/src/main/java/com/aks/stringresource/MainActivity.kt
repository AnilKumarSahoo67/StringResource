...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.name1.text = Html.fromHtml(getString(R.string.welcome_messages,"Anil",2,"Thank you!"),
        ...
        spannableStr.setSpan(clickableSpan,0,spannableStr.length,Spannable.SPAN_INCLUSIVE_EXCLUSIVE)
        ...
        val spannableTextLess = SpannableStringBuilder(getString(R.string.expandable_text).substring(0,100))

        val clickableSpan1 = object : ClickableSpan(){
            override fun onClick(p0: View) {
//                binding.name7.visibility = View.GONE
//                binding.name6.visibility = View.VISIBLE
        ...
        val clickableSpan2 = object : ClickableSpan(){
            override fun onClick(p0: View) {
//                binding.name7.visibility = View.VISIBLE
//                binding.name6.visibility = View.GONE
        ...
        seeLessSpannable.setSpan(clickableSpan1,0,seeLessSpannable.length,Spannable.SPAN_INCLUSIVE_EXCLUSIVE)
        val seeMoreSpannable = SpannableString(" ..see more")
        seeMoreSpannable.setSpan(clickableSpan2,0,seeMoreSpannable.length,Spannable.SPAN_INCLUSIVE_EXCLUSIVE)

        spannableText.append(seeLessSpannable)
        spannableTextLess.append(seeMoreSpannable)

        binding.name6.text = spannableTextLess
        binding.name7.text = spannableText
